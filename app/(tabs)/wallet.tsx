...
import { AccountCard, AccountListItem, StablecoinListItem } from "@/components/wallet/account-card";
    ...
    <>
      ...
      >
        <Box gap={6}>
          <TouchableOpacity
            style={[
              styles.walletNameBadge,
              { backgroundColor: "#1A2F4A", borderColor: "#3B82F650" },
            ]}
            onPress={() => setSwitcherVisible(true)}
          >
            <Text variant="h5" color="#fff">
              {wallet?.name ?? "Мой кошелек"}
            </Text>
      ...
      >
        ...
        <StablecoinListItem symbol="USDC" accounts={accounts} />
        <StablecoinListItem symbol="USDT" accounts={accounts} />
        {/* Network list */}
                <Box
          row
          justifyContent="space-between"
          ...
          <AccountListItem
            ...
            onPress={() =>
              router.push({
                ...
                params: { network: account.network },
              })
            }
          />
        ))}
