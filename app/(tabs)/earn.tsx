		...
		<TouchableOpacity onPress={onPress} activeOpacity={0.8}>
			...
			>
				...
				<Box flex gap={4}>
					...
					<Text variant="caption" color={protocol.subtitleColor}>
						{protocol.subtitle}
					</Text>
				</Box>
				...
				<Box
					...
					py={8}
					borderRadius={12}
					backgroundColor={protocol.apyBg}
				>
					<Text fontSize={18} fontWeight="700" color="#10B981">
						{protocol.apy}
					</Text>
					<Text fontSize={11} fontWeight="500" color="#6B7280">
						в год
					</Text>
				</Box>
			</Box>
	...
	return (
		...
		>
			<Box
				...
				alignItems="center"
				justifyContent="center"
				backgroundColor={position.iconBg}
			>
			...
			<Box alignItems="flex-end" gap={2}>
				<Text variant="p3" fontWeight="700" color="#10B981">
					{position.income}
				</Text>
			...
			>
				...
				>
					<Box row justifyContent="space-between" alignItems="center">
						<Box gap={4}>
							<Text variant="caption-medium" color="#6B7280">
								Общий доход
							</Text>
							<Text variant="h2" color="#10B981">
								$127.43
							</Text>
						</Box>
						<Box
					...
					{filteredProtocols.length === 0 && (
						<Box py={32} alignItems="center" gap={8}>
							...
							<Text variant="p3" color="#6B7280">
								Нет протоколов для этого фильтра
							</Text>
						</Box>
					)}
				</Box>
